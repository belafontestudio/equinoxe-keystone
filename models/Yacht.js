...
Yacht.schema.pre('save', function(next) {
	...
	if (pdfToGenerate != 0){
		console.log("pdf to generate "+pdfToGenerate);
		var finished = _.after(pdfToGenerate, next);
	}else{
		console.log("no pdf to generate ");
		next();
	}
...
function pdfFullNoLogo(finished,yacht){
	console.log("pdfFullNoLogo called");
		var slug;
		if (yacht.slug == "giocagio"){
			slug = yacht.slug+"_yacht.pdf";
		}else{
			slug= yacht.slug+".pdf";
		}
		var options = { filename: process.env.CLOUD_DIR+"/generated/pdf/full-no-logo/"+slug, format: 'A4', "header":{"height":"30mm","contents":'<div id="header" class="big" style="height:20mm; width:810px; margin-left: -110px; text-align: center;"></div>' },
		"timeout": 30000,
		"footer": {
			"height": "20mm",
		...
		request(process.env.WEB_URL+"/api/pdf/full/"+yacht.slug,function (error, response, body) {
			pdf.create(body, options).toFile(function(err, res) {
				...
				yacht["pdfFull noLogo url"] = process.env.WEB_URL+"/generated/pdf/full-no-logo/"+slug;
...
function pdfLiteNoLogo(finished,yacht){
	console.log("pdfLiteNoLogo called");
		...
		var options = { filename: process.env.CLOUD_DIR+"/generated/pdf/lite-no-logo/"+slug, format: 'A4', "header":{"height":"30mm","contents":'<div id="header" class="big" style="height:20mm; width:810px; margin-left: -110px; text-align: center;"></div>' },
		"timeout": 30000,
		"footer": {
			"height": "20mm",
			"contents": '<div id="footer-wrap" style="height:18mm; border-top:1px solid #103158; float: left;clear: none;text-align: inherit;width: 810px;position: absolute;bottom: 0; left:-20px; padding-left:20px; background: white; color:#103158;"><div class="footer" style="width: 82.8333333333333%;margin-left: 0%;margin-right: 3%;position: relative;left: 8.5833333333333%;padding: 0;text-align: center; font-size: 7px"></div></div>'
		...
		request(process.env.WEB_URL+"/api/pdf/lite/"+yacht.slug,function (error, response, body) {
			pdf.create(body, options).toFile(function(err, res) {
				...
				yacht["pdfLite noLogo url"] = process.env.WEB_URL+"/generated/pdf/lite-no-logo/"+slug;
...
function pdfFull(finished,yacht){
	console.log("pdfFull called");
		...
		request(process.env.WEB_URL+"/api/pdf/full/"+yacht.slug,function (error, response, body) {
					...
					yacht["pdfFull url"] = process.env.WEB_URL+"/generated/pdf/full/"+slug;
...
function pdfLite(finished,yacht){
	console.log("pdfLite called");
		...
		var options = { 
				filename: process.env.CLOUD_DIR+"/generated/pdf/lite/"+slug, 
				format: 'A4',
				"timeout": 30000, 
				"header":{"height":"30mm","contents":'<div id="header" class="big" style="height:20mm; width:810px; margin-left: -110px;  text-align: center; "><img style="width:220px;" src="data:image/png;base64,"></div>' },
				"footer": {
					"height": "20mm",
					"contents": '<div id="footer-wrap" style="height:18mm !important; border-top:1px solid #103158 !important; background: #FFFFFF !important;  float: left !important;clear: none !important;text-align: inherit !important; width: 810px !important; position: absolute !important;bottom: 0 !important; left:-20px !important; padding-left:20px !important; color:#103158 !important;"><div class="footer" style="width: 70% !important; margin-left: 10px !important;  position: absolute !important; bottom:0 !important; padding: 0 !important; text-align: center !important; font-size: 7px !important"><ul style=" list-style: none !important; "><li style="display: inline-block !important; font-size: 7px !important;">Equinoxe Yachts | &nbsp;</li><li style="display: inline-block !important; font-size: 7px !important;">Via dei Mille 18, Torino, Italy | &nbsp;</li><li style="display: inline-block !important; font-size: 7px !important;">+39 011 8185211 | </li><li style="display: inline-block !important; font-size: 7px !important;">&nbsp;yachts@equinoxe.it</li></ul><p font-size: 7px !important;">All yachts offered are subject to still being available. Yacht particulars are believed to be correct but their contents are not guaranteed, neither may they be used for any contractual purposes. Specification provided for information only. Subject to prior sale, price change or withdrawal from market without notice.</p></div></div>'
					}
				...
				request(process.env.WEB_URL+"/api/pdf/lite/"+yacht.slug,function (error, response, body) {
					pdf.create(body, options).toFile(function(err, res) {
						...
						yacht["pdfLite url"] = process.env.WEB_URL+"/generated/pdf/lite/"+slug;
